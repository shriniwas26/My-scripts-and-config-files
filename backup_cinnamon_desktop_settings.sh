...
ROTATE_DAYS=20
zip -rv "$BACKUP_FOLDER/linux_mint_config_$(date +"%Y_%m_%d_%H%M").zip" ~/.atom/*.cson ~/.config ~/.cinnamon ~/.gconf ~/.icons ~/.themes -x \*libreoffice* \*spotify* \*chromium* \*google-chrome* \*Virtualbox* \*Cache* \*IndexedDB*
